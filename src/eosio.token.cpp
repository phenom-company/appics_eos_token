...
uint64_t token::get_steem_inflation() {
   // TODO implement the calculation of the emissions of the token
   return 0;
}

} /// namespace eosio

EOSIO_DISPATCH( eosio::token, (create)(mint)(issue)(transfer)(open)(close)(retire) )
